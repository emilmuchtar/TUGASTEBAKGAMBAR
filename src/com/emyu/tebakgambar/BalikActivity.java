...
public class BalikActivity extends Activity {
	EditText jawabanTxt;
	@Override
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.balik, menu);
		return true;
	}
	public void cekJawaban(View v){
		String jawabanBenar = "BALIK PAPAN";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), GoyangActivity.class);
			startActivity(i);
		}
