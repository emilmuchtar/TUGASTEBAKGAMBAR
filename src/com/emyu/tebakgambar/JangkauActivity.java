...
public class JangkauActivity extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_jangkau);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.jangkau, menu);
		return true;
	}
	public void cekJawaban(View v){
		String jawabanBenar = "JANGKAU AKU";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), KurasaActivity.class);
			startActivity(i);
		}
