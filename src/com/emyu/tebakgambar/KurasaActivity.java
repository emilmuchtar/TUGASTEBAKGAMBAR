...
public class KurasaActivity extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_kurasa);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.kurasa, menu);
		return true;
	}
	public void cekJawaban(View v){
		String jawabanBenar = "KURASA CINTA";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), PasarActivity.class);
			startActivity(i);
		}
