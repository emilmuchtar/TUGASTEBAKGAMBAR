...
public class RotiActivity extends Activity {
	EditText jawabanTxt;
	@Override
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.roti, menu);
		return true;
	}
	public void cekJawaban(View v){
		String jawabanBenar = "ROTI BUAYA";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), SarungActivity.class);
			startActivity(i);
		}
