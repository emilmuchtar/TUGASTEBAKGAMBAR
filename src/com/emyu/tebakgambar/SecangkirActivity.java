...
public class SecangkirActivity extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_secangkir);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.secangkir, menu);
		return true;
	}
	public void cekJawaban(View v){
		String jawabanBenar = "SECANGKIR KOPI PANAS";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), SetengahActivity.class);
			startActivity(i);
		}
