...
public class SetengahActivity extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_setengah);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.setengah, menu);
		return true;
	}
	public void cekJawaban(View v){
		String jawabanBenar = "CINTA SETENGAH MATI";
